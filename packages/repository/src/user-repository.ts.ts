...
export class UserRepository extends Repository {
	...
	async GetStudyGroupUserIds(id: number) {
	...
	FindStudyGroup(where: { grade?: number; letter?: string; title: string }) {
		return this.prisma.studyGroup.findFirst({ where });
	}

	CreateStudyGroup(data: { grade?: number; letter?: string; title: string }) {
